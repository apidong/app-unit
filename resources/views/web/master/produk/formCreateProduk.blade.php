    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form action="<?= url('master/produk') ?>" method="post" enctype="multipart/form-data"
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2 @error('kategori') is-invalid @enderror"
                                        ...
                                        @foreach ($kategori as $value)
                                            <option value="{{ $value->id }}" @selected(old('kategori') == $value->id)>
                                                {{ $value->nama }}</option>
                                        @endforeach
                                    </select>
                                    @error('kategori')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama">{{ old('deskripsi') }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">
                                            <h6>{{ $message }}</h6>
                                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="sku"
                                        class="form-control @error('nama') is-invalid @enderror" value="{{ old('sku') }}"
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="harga"
                                        ...
                                        value="{{ old('harga') }}" placeholder="Harga Produk" autocomplete="off">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="berat"
                                        ...
                                        value="{{ old('berat') }}" placeholder="Berat Produk" autocomplete="off">
                            ...
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <input type="text" name="ukuran[width]"
                                        ...
                                        value="{{ old('ukuran["width"]') }}" placeholder="L" autocomplete="off">
                                    @error('ukuran["width"]')
                                        <div class="invalid-feedback">
                                            <h6>{{ $message }}</h6>
                                        </div>
                            ...
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <input type="text" name="ukuran[length]"
                                        ...
                                        value="{{ old('ukuran["length"]') }}" placeholder="P" autocomplete="off">
                                    @error('ukuran["length"]')
                                        <div class="invalid-feedback">
                                            <h6>{{ $message }}</h6>
                                        </div>
                            ...
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <input type="text" name="ukuran[height]"
                                        ...
                                        value="{{ old('ukuran["height"]') }}" placeholder="T" autocomplete="off">
                                    @error('ukuran["height"]')
                                        <div class="invalid-feedback">
                                            <h6>{{ $message }}</h6>
                                        </div>
