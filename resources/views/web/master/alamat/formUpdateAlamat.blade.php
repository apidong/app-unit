    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form action="<?= url("master/alamat/{$alamat->id}") ?>" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama"
                                        class="form-control @error('nama') is-invalid @enderror" value="{{ $alamat->nama }}"
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control-sm @error('nama_prov') is-invalid @enderror" id="provinsi"
                                    ...
                                    <option selected value="{{ substr($alamat->kode_kec, 0, 2) }}">{{ $alamat->nama_prov }}
                                    </option>
                                </select>
                                @error('nama_prov')
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control-sm @error('nama_kab') is-invalid @enderror" id="kabupaten"
                                    ...
                                    <option selected value="{{ substr($alamat->kode_kec, 0, 5) }}">{{ $alamat->nama_kab }}
                                    </option>
                                </select>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control-sm @error('nama_kec') is-invalid @enderror" name="nama_kec"
                                    ...
                                    <option value="{{ $alamat->kode_kec }}" selected>{{ $alamat->nama_kec }}</option>
                                </select>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kode_pos"
                                        ...
                                        value="{{ $alamat->kode_pos }}" placeholder="Kode Pos" autocomplete="off">
                                    @error('kode_pos')
                                        <div class="invalid-feedback">
                                            <h6>{{ $message }}</h6>
                                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                        placeholder="Nama jalan, Gedung, Nomor Rumah">{{ $alamat->alamat }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            <h6>{{ $message }}</h6>
                                        </div>
                        ...
                        <input type="hidden" id="latitude" name="latitude" value="{{ $alamat->region['latitude'] }}">
                        <input type="hidden" id="longitude" name="longitude"
                            value="{{ $alamat->region['longitude'] }}">
