    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form action="<?= url('master/kategori') ?>" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control-sm" id="provinsi" data-placeholder="Pilih Provinsi"
                                    style="width: 100%;">
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control-sm" id="kabupaten" disabled
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control-sm" name="kecamatan" id="kecamatan" disabled
